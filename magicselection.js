...
;( function( window ) {
	...
	magicSelection.prototype._initEvents = function() {
		...
		this.items.forEach( function( el ) {
			el.addEventListener( 'mousedown', function( ev ) {unFocus(); self._selectHandler( this, ev ); } );
			el.addEventListener( 'mouseup', function() {unFocus(); self.abortSelection(); } );
			el.addEventListener( 'mouseover', function(ev) {unFocus(); if( isMouseLeaveOrEnter( ev, this ) && self.isOnSelection ) self._selectHandler( this, ev, true ); } );
			el.addEventListener( 'mouseout', function(ev) {unFocus(); if( isMouseLeaveOrEnter( ev, this ) ) self.abortSelection(); } );
			el.addEventListener( 'click', function( ev ) {unFocus(); self._clickHandler( this, ev ); } );
			document.addEventListener( 'mouseup', function( ev ) {unFocus(); if( self.isOnSelection ) self._unselectAllHandler( ev ); } );
		} );
