...
content_tables = container_table.getElementsByTagName("table"); //the 4/5 tables for assignments. course page etc
course_material_table = content_tables[content_tables.length - 1]; //last table in the container table
...
for (i = 0; i < s.length; i++) {
    ...
    s[i].parentNode.parentNode.setAttribute("width", "190");
    ...
    //onclick event for the i'th <a> tag's row
